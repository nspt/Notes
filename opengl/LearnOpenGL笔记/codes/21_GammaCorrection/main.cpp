...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        ShaderProgram general_shader{
            resourceDir + "shaders/21_gamma_correction/general_0.vert",
            resourceDir + "shaders/21_gamma_correction/general_0.frag"
        };
        ...
        ShaderProgram visual_normal_shader{
            resourceDir + "shaders/21_gamma_correction/visual_normal_0.vert",
            resourceDir + "shaders/21_gamma_correction/visual_normal_0.frag",
            resourceDir + "shaders/21_gamma_correction/visual_normal_0.geom"
        };
        ...
        ShaderProgram explode_shader {
            resourceDir + "shaders/21_gamma_correction/explode_0.vert",
            resourceDir + "shaders/21_gamma_correction/explode_0.frag",
            resourceDir + "shaders/21_gamma_correction/explode_0.geom"
        };
        ...
        ShaderProgram skybox_shader{
            resourceDir + "shaders/21_gamma_correction/skybox_0.vert",
            resourceDir + "shaders/21_gamma_correction/skybox_0.frag"
        };
        ...
        mirror.material_.program_ = ShaderProgram {
            resourceDir + "shaders/21_gamma_correction/kernel_1.vert",
            resourceDir + "shaders/21_gamma_correction/kernel_1.frag"
        };
