...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        ShaderProgram general_shader{
            resourceDir + "shaders/21_gamma_correction/general.vert",
            resourceDir + "shaders/21_gamma_correction/general.frag"
        };
        ...
        ShaderProgram visual_normal_shader{
            resourceDir + "shaders/21_gamma_correction/visual_normal.vert",
            resourceDir + "shaders/21_gamma_correction/visual_normal.frag",
            resourceDir + "shaders/21_gamma_correction/visual_normal.geom"
        };
        ...
        ShaderProgram explode_shader {
            resourceDir + "shaders/21_gamma_correction/explode.vert",
            resourceDir + "shaders/21_gamma_correction/explode.frag",
            resourceDir + "shaders/21_gamma_correction/explode.geom"
        };
        ...
        ShaderProgram skybox_shader{
            resourceDir + "shaders/21_gamma_correction/skybox.vert",
            resourceDir + "shaders/21_gamma_correction/skybox.frag"
        };
        ...
        mirror.material_.program_ = ShaderProgram {
            resourceDir + "shaders/21_gamma_correction/kernel.vert",
            resourceDir + "shaders/21_gamma_correction/kernel.frag"
        };
