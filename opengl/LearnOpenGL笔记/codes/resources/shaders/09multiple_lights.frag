...
void main()
{
    ...
    vec4 ambient = texture(material.diffuse_map, v_tex_coord);
    vec4 diffuse = texture(material.diffuse_map, v_tex_coord);
    vec4 specular = texture(material.specular_map, v_tex_coord);
