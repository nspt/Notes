...
Texture2DMS::Texture2DMS(int width, int height, GLenum format, GLsizei samples,
                         GLboolean fixedSampleLocations)
    : Texture{ GL_TEXTURE_2D_MULTISAMPLE }
{
    init(width, height, format, samples, fixedSampleLocations);
}

void Texture2DMS::reallocate(int width, int height, GLenum format, GLsizei samples,
                             GLboolean fixedSampleLocations)
{
    data_->width_ = width;
...
void Texture2DMS::init(int width, int height, GLenum format, GLsizei samples,
