...
void Renderer::loadShaders(const std::string &resourceDir)
{
    ...
    add("general",
        resourceDir + "shaders/24_parallex_mapping/general.vert",
        resourceDir + "shaders/24_parallex_mapping/general.frag");
    shaders_.at("general").setUniformBlockBinding("LightData", 0);
    shaders_.at("general").setUniformBlockBinding("CamData", 1);

    add("shadow",
        resourceDir + "shaders/24_parallex_mapping/shadow.vert",
        resourceDir + "shaders/24_parallex_mapping/shadow.frag");

    add("cube_shadow",
        resourceDir + "shaders/24_parallex_mapping/cube_shadow.vert",
        resourceDir + "shaders/24_parallex_mapping/cube_shadow.frag",
        resourceDir + "shaders/24_parallex_mapping/cube_shadow.geom");

    add("visual_normal",
        resourceDir + "shaders/24_parallex_mapping/visual_normal.vert",
        resourceDir + "shaders/24_parallex_mapping/visual_normal.frag",
        resourceDir + "shaders/24_parallex_mapping/visual_normal.geom");
    shaders_.at("visual_normal").setUniformBlockBinding("CamData", 1);
    shaders_.at("visual_normal").setVec3("normal_color", glm::vec3{ 0, 1, 0 });

    add("explode",
        resourceDir + "shaders/24_parallex_mapping/explode.vert",
        resourceDir + "shaders/24_parallex_mapping/explode.frag",
        resourceDir + "shaders/24_parallex_mapping/explode.geom");
    shaders_.at("explode").setUniformBlockBinding("LightData", 0);
    shaders_.at("explode").setUniformBlockBinding("CamData", 1);

    add("explode_shadow",
        resourceDir + "shaders/24_parallex_mapping/shadow_explode.vert",
        resourceDir + "shaders/24_parallex_mapping/shadow_explode.frag",
        resourceDir + "shaders/24_parallex_mapping/shadow_explode.geom");

    add("skybox",
        resourceDir + "shaders/24_parallex_mapping/skybox.vert",
        resourceDir + "shaders/24_parallex_mapping/skybox.frag");
    shaders_.at("skybox").setUniformBlockBinding("CamData", 1);
    shaders_.at("skybox").setInt("skybox", 0);

    add("kernel",
        resourceDir + "shaders/24_parallex_mapping/kernel.vert",
        resourceDir + "shaders/24_parallex_mapping/kernel.frag");
