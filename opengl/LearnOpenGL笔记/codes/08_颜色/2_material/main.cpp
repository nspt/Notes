...
RenderObject createCube(const std::string &resourceDir, const glm::mat4 &projection)
{
    RenderObject obj;
    obj.mesh_ = createCubeMesh();
    ...
    obj.material_->ambient_ = glm::vec3{ 1.0f, 0.5f, 0.31f };
    obj.material_->diffuse_ = glm::vec3{ 1.0f, 0.5f, 0.31f };
    obj.material_->specular_ = glm::vec3{ 0.5f };
    obj.material_->shininess_ = 32.0f;

    return obj;
}

RenderObject createLightCube(const std::string &resourceDir, const glm::mat4 &projection)
{
    RenderObject obj;
    obj.mesh_ = createCubeMesh();
    obj.material_ = std::make_shared<Material>();
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        cube_material->specular_ = glm::vec3{ 0.5f };
