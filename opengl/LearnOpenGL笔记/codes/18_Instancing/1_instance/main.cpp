...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        ShaderProgram general_shader{
            resourceDir + "shaders/18_instancing/general.vert",
            resourceDir + "shaders/18_instancing/general.frag"
        };
        ...
        ShaderProgram visual_normal_shader{
            resourceDir + "shaders/18_instancing/visual_normal.vert",
            resourceDir + "shaders/18_instancing/visual_normal.frag",
            resourceDir + "shaders/18_instancing/visual_normal.geom"
        };
        ...
        ShaderProgram explode_shader {
            resourceDir + "shaders/18_instancing/explode.vert",
            resourceDir + "shaders/18_instancing/explode.frag",
            resourceDir + "shaders/18_instancing/explode.geom"
        };
        ...
        ShaderProgram skybox_shader{
            resourceDir + "shaders/18_instancing/skybox.vert",
            resourceDir + "shaders/18_instancing/skybox.frag"
        };
        ...
        mirror.material_.program_ = ShaderProgram {
            resourceDir + "shaders/18_instancing/kernel.vert",
            resourceDir + "shaders/18_instancing/kernel.frag"
        };
