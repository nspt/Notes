...
public:
    ...
    void reallocate(int width, int height, GLenum internalFormat, GLenum format, void *data = nullptr);
    void reallocate(int width, int height, GLenum format, void *data = nullptr);

private:
    void init(void *data, int width, int height, GLenum internalFormat, GLenum format) noexcept;
};
