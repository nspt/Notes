...
{
    Material material;
    material.diffuse_textures_.push_back(Texture2D(resourceDir + "/textures/brickwall.jpg"));
    material.normal_textures_.push_back(Texture2D(resourceDir + "/textures/brickwall_normal.jpg", true, false));
